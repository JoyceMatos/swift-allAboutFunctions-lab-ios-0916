 ...
 */
let characterName = "Christina"
favoriteCharacter(characterName)

var leadingCharacter = "Meredith"
favoriteCharacter(leadingCharacter)

leadingCharacter = "McDreamy"
favoriteCharacter(leadingCharacter)
 ...
 */
func madLib(characterName2: String, noun: String, preposition: String) {
    let characterName2 = "Meredith"
    let noun = "infinity"
    let preposition = "beyond"
    print("To \(noun) and \(preposition), \(characterName2)!")
}

madLib("Meredith", noun: "infinity", preposition: "beyond")
 ...
 */
func disneyMovie(character1: String) -> String {
    return "To infinity and beyond \(character1.uppercaseString)!"
}
